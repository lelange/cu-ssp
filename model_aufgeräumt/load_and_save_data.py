...
train_dssp, train_pssm_list, train_hmm_list= cullpdb_df[['dssp', 'pssm', 'hhm']][cullpdb_df['seq'].apply(len)<=maxlen_seq].values
test_dssp, test_pssm_list, test_hmm_list = data13_df[['dssp', 'pssm', 'hhm']][data13_df['seq'].apply(len)<=maxlen_seq].values
