...
def build_model_ho_3(params):
    ...
    model.compile(optimizer=adamOptimizer, loss="categorical_crossentropy", metrics=["accuracy", accuracy, matthews_correlation])
...
best_weights = "model/644417_mod_3-CB513-2019_08_04-19_52.h5"
